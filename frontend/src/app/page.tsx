...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#070e22] text-gray-100 selection:bg-amber-500 selection:text-slate-950 font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <footer className="border-t border-blue-500/15 bg-[#050a17]/90 py-2 px-6 text-center text-[11px] text-gray-400 shrink-0">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-1">
            ...
            <span className="font-mono text-[10px] text-amber-300/80">
              CIBRC 1968 Statutory Compliance • Edge-TTS ValluvarNeural (₹0 Architecture)
            </span>
          </div>
        </footer>
